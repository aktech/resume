...
\runsubsection{Cambridge Medical Robotics}
\descript{| Software Engineer (Contractor) }
\location{Cambridge, United Kingdom | June 2018 - Present}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
% \item Visa Status: Tier 1 Exceptional Talent, Valid till 2023
...
\runsubsection{The Telegraph}
\descript{| Data Platform Engineer }
\location{London, United Kingdom | February 2018 - May 2018}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
% \item Visa Status: Tier 1 Exceptional Talent, Valid till 2023
...
\runsubsection{Google Summer of Code 2018, 2017, 2016}
\descript{| Mentor }
