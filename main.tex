...
\location{R \& D Team | June 2016 - Present}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
\item Facilitated the collection of standard error logs.
\item Wrote an Error Log Parser for C, C++, Python and Java.
\item Working on making the Code Editor Intelligent to give suggestions to the user by analyzing the error log, to improve their code.
\end{tightemize}
\sectionsep
...
\item Introducing MetaClasses", PyDelhi Meetup. (*Selected talks listed)
\end{tightemize}
